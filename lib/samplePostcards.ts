...
export const samplePostcards: SamplePostcard[] = [
  ...
  },
  {
    ...
    location: "Dresden",
    language: "German",
    frontImage: "samples/christmas_front.jpg",
    backImage: "samples/christmas_back.jpg",
    imageOnly: true,
  },
  {
    ...
    location: "Dresden",
    language: "German",
    frontImage: "samples/dresden_bw_front.jpg",
    backImage: "samples/dresden_bw_back.jpg",
    imageOnly: true,
  },
  {
    ...
    location: "Dresden",
    language: "German",
    frontImage: "samples/dresden_color_front.jpg",
    backImage: "samples/dresden_color_back.jpg",
    imageOnly: true,
  },
  {
    ...
    location: "Dresden",
    language: "German",
    frontImage: "samples/standseilbahn_front.jpg",
    backImage: "samples/standseilbahn_back.jpg",
    imageOnly: true,
  },
  {
    id: "sample-neujahr",
    ...
    location: "Dresden",
    language: "German",
    frontImage: "samples/neujahr_front.jpg",
    backImage: "samples/neujahr_back.jpg",
    imageOnly: true,
  },
  {
    id: "sample-scouts",
    ...
    location: "Germany",
    language: "German",
    frontImage: "samples/scouts_front.jpg",
    backImage: "samples/scouts_back.jpg",
    imageOnly: true,
  },
  {
    id: "sample-deer",
    ...
    location: "Germany",
    language: "German",
    frontImage: "samples/deer_front.jpg",
    backImage: "samples/deer_back.jpg",
    imageOnly: true,
  },
  {
    ...
    language: "German",
    frontImage: "samples/christmas_front.jpg",
    backImage: "samples/dresden_letter_back.jpg",
    imageOnly: true,
  },
  {
    ...
    location: "Dresden",
    language: "German",
    frontImage: "samples/dresden_panorama_front.jpg",
    backImage: "samples/dresden_panorama_back.jpg",
    imageOnly: true,
  },
];
